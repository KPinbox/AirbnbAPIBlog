...
complete_curl_request: "curl -X POST -d \"client_id=3092nxybyb0otqw18e8nh5nty\" -d \"locale=en-US\" -d \"currency=USD\" -H \"X-Airbnb-OAuth-Token: 9nwld6we4td9vkwj160teb49a\" -H \"Content-Type: application/json; charset=UTF-8\" --data-binary \"{\"listing\":{\"has_availability\":true}}\" --compressed https://api.airbnb.com/v1/listings/12132179/update"
...
body: '{"listing":{"has_availability":true}}'
